...
WebUI.click(findTestObject('Object Repository/Page_Town Square - cdnc Mattermost/button_1'))

WebUI.setText(findTestObject('Page_Town Square - cdnc Mattermost/textarea_Add a comment_reply_textbox'), replyText)

WebUI.click(findTestObject('Page_Town Square - cdnc Mattermost/input_Help_addCommentButton'))

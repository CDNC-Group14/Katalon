...
WebUI.click(findTestObject('Page_pensive - cdews Mattermost/button_Edit'))

WebUI.setText(findTestObject('Object Repository/Page_pensive - cdews Mattermost/input_Allow only users with a specific emai_44da11'), 
    domainUser)

WebUI.click(findTestObject('Page_pensive - cdews Mattermost/button_Save'))
